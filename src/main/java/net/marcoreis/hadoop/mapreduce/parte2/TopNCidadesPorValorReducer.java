...
public class TopNCidadesPorValorReducer
		extends Reducer<LongWritable, Text, LongWritable, Text> {
	private Map<Text, IntWritable> mapa = new HashMap<Text, IntWritable>();

	@Override
	protected void reduce(LongWritable chave,
			Iterable<Text> valores, Context context)
	...
	private Map<Text, IntWritable> ordenarMapa(
			Map<Text, IntWritable> mapa) {
		return null;
	}
}
